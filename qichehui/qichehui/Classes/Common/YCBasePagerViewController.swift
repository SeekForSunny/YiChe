//
//  YCBasePagerViewController.swift
//  qichehui
//
...
protocol YCSubScrollViewScrollDelegate:class {
    func subScrollViewDidScroll(_ scrollView: UIScrollView);
}

class YCBasePagerViewController: UIViewController,UIScrollViewDelegate {
    weak var delegate:YCSubScrollViewScrollDelegate?
